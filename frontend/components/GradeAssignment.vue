<template>
  <div style="position: relative">
    ...
    <v-row no-gutters class="main">
      <v-col cols="8">
        <div class="col">
          ...
          <p class="text--secondary">
            ...
            <v-dialog v-if="description.length" v-model="dialog" width="500">
      ...
      <v-col cols="2">
        <div class="col">
          <b class="text--primary">{{ dateNote }}</b
          ><br />
      ...
      <v-col cols="2">
        <div class="col" :style="'color: ' + gradeColor">
          ...
          <p class="grade-bottom">/ {{ grade[1] }}</p>
        </div>
      </v-col>
    </v-row>
    <v-divider />
...
export default {
  ...
  computed: {
    ...
    gradeColor() {
      if (this.grade[1] === 0) return colors.grey.lighten1
    ...
    dateNote() {
      if (!this.dateDue || this.dateDue > Date.now()) return "Upcoming"
      return "Date Graded"
    },
    date() {
